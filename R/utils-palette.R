...
.pal_sets <- list(
  ...
  dusk = c(
    "#274753", "#297270", "#299d8f", "#8ab07c", "#e7c66b",
    "#f3a361", "#e66d50"
  ),
  gentle = c(
    "#a1a9d0", "#f0988c", "#b883d3", "#9e9e9e", "#cfeaf1",
  ...
  ReYebl = c(
    "#d53e4f", "#fc8d59", "#fee08b", "#ffffbf", "#e6f598",
    "#99d594", "#3288bd"
  ), # 渐变色 红-黄-蓝
  PuWhGr = c(
    "#c51b7d", "#e9a3c9", "#fde0ef", "#f7f7f7", "#e6f5d0",
    "#a1d76a", "#4d9221"
  ), # 渐变色 紫-白-绿
  ReWhBl = c(
    "#b2182b", "#ef8a62", "#fddbc7", "#f7f7f7", "#d1e5f0",
    "#67a9cf", "#2166ac"
  ), # 渐变色 红-白-蓝
  BrWhCy = c(
    "#8c510a", "#d8b365", "#f6e8c3", "#f5f5f5", "#c7eae5",
    "#5ab4ac", "#01665e"
  ) # 渐变色 褐-白-青
)
...
palc <- function(name = NULL, n = NULL, paste = FALSE, ...) {
  ...
  if (name == "YeBr") {
    x <- grDevices::colorRampPalette(c("#F3DA7D", "#A13043"))(n)
  } # 渐变色 黄-褐
  if (name == "BlWhRe") {
    x <- grDevices::colorRampPalette(c("#3288bd", "#ffffff", "#d53e4f"))(n)
  } # 渐变色 蓝-白-红
  if (name == "BrWhCy") {
  ...
  if (name == "PiWhCy") {
    x <- grDevices::colorRampPalette(c(
      "#de77ae", "#f1b6da", "#fde0ef", "#ffffff", "#c7eae5",
      "#80cdc1", "#35978f"
    ))(n)
  } # 渐变色 粉-白-青
  if (name == "Rainbow1") {
